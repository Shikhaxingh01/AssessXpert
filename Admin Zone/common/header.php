            ...
            <div id="page-content-wrapper" style="bg-color:blue;">
                ...
                <nav class="navbar navbar-expand-lg navbar-gray bg-light border-bottom" style="width:100%; margin:0px;padding:0px;">
                    <div class="container-fluid">
                        <button class="btn btn-primary" id="sidebarToggle" > >>Toggle Menu</button><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome To Admin Panel</h3>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <i class="fa fa-user-circle fa-2x" aria-hidden="true"  class="link" style="color:black;"></i><b>Admin</b>
